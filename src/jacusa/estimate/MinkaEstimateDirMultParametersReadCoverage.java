...
public class MinkaEstimateDirMultParametersReadCoverage extends MinkaEstimateParameters {
	...
	public MinkaEstimateDirMultParametersReadCoverage() {
		super();
	}

	public MinkaEstimateDirMultParametersReadCoverage(final AbstractAlphaInit initialAlpha) {
