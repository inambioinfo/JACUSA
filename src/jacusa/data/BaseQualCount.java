...
public class BaseQualCount {
	...
	public BaseQualCount() {
		baseCount 	= new int[BaseConfig.BASES.length];
		base2qual	= new int[BaseConfig.BASES.length][Phred2Prob.MAX_Q];
		minQual		= new int[BaseConfig.BASES.length];
	...
	public void invert() {
		int[] tmpBaseCount = new int[BaseConfig.BASES.length];
		int[][] tmpQualCount = new int[BaseConfig.BASES.length][Phred2Prob.MAX_Q];
	...
	public int[] getAlleles() {
		// make this allele
		int[] alleles = new int[BaseConfig.BASES.length];
		int n = 0;
	
		for (int baseIndex = 0; baseIndex < BaseConfig.BASES.length; ++baseIndex) {
