...
public class TwoConditionIterator extends AbstractTwoConditionIterator {

	public TwoConditionIterator(
		...
		super(coordinate, filter, readers1, readers2, condition1, condition2, parameters);
	}
